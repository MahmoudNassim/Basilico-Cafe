    ...
    <div className=" w-full max-md:py-2   text-white">
      <div className="md:flex hidden justify-between px-10 py-5 ">
        <div className="flex gap-3 items-center ">
          ...
          <div className="flex flex-col text-white">
            <h2>LOCATION</h2>
            <p style={{ fontFamily: "DM Sans, sans-serif" }}>448 West Foxrun St. Bronx</p>
          </div>
        </div>
        <div className="flex gap-3 items-center ">
          <div className="flex flex-col text-white">
            <h2 className="text-end">CALL DELIVERY</h2>
            <p style={{ fontFamily: "DM Sans, sans-serif" }}>(734) 665-1852 or (770) 942-7739</p>
          </div>
          <div className="bg-[#C3A27C] rounded-full w-12 h-12 flex justify-center items-center">
      ...
      <div className=" bg-[#2D2723] rounded-full pl-[54px] pr-[54px] max-md:p-4 py-4 flex items-center min-lg:justify-around justify-between gap-5 relative h-[10vh] ">
        <div className="w-[10%] max-lg:p-0 max-md:w-[33%] ">
          <button className="flex items-center cursor-pointer" onClick={handleClickMenu}>
            <TbMenu4 className="text-start text-4xl " />
          </button>

          {open && <DropdownCard open={open} setOpen={setOpen} />}
          {openOffCanvas && <Offcanvas open={openOffCanvas} setOpen={setOpenOffcanvas} />}
        </div>
        ...
        <div className="w-[25%] max-md:w-[33%]  flex justify-center items-center cursor-pointer  rounded-full">
          <Link to='/'>
            <img src={logo} alt="" className="w-20 h-20 max-md:w-17 max-md:h-17  outline-[10px] outline-[#FAF1E3]  rounded-full " />
          </Link>
        </div>
