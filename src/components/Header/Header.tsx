...
const Header = () => {
  ...
  return (
    <div
      className={`fixed z-50 top-[0.5px] left-1/2 -translate-x-1/2 max-md:py-2 w-full lg:w-[80%] text-white  ${
        isSticky
          ? " bg-[#2D2723]  rounded-full shadow-lg transition-all duration-150"
          : ""
      }`}
    >
      <div
        className={`md:flex hidden justify-between px-10 py-5 ${
          isSticky ? "md:hidden" : ""
        } `}
      >
